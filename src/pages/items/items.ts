...
export class ItemsPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    if (this.service) {
      ...
      navCtrl.setRoot("NewskithomePage");
    }
  }
  ...
  selectPageForOpen(value: string): any {
    ...
    switch (value) {
      ...
      case "actionSheet":
        ...
        break;
      case "newskitHome":
        page = "NewskithomePage";
        break;
      case "newskitnewslist":
        page = "NewskitnewslistPage";
        break;
  ...
  navigation(page: any) {
    if (page.listView) {
      console.log("I m called here if item.ts")
      this.navCtrl.push(ItemsPage, {
        componentName: page.theme
      });
    } else {
      console.log("I m called in else item.ts")
