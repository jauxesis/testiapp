...
export class MenuService implements IService {
    ...
    getAllThemes = (): Array<any> => {
      return [ 
        {"title" : "news home", "theme"  : "newskitHome",  "icon" : "icon-format-align-justify", "listView" : false, "component": "NewskithomePage", "singlePage":true},
        {"title" : "news", "theme"  : "newskitnewslist",  "icon" : "icon-format-align-justify", "listView" : false, "component": "NewskitnewslistPage", "singlePage":true},        
